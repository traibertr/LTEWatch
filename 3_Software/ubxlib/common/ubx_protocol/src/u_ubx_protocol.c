...
// ---- M9 Protocol : 8 UBX-MON-MSGPP (0x0a 0x06)
// Cast twice to keep Lint happy
...
// ---- M10 Protocol : UBX-MON-COMMS (0x0a 0x36)
    retValue += ((uint64_t) *(pInput + 1)) << 8;
    retValue += ((uint64_t) *(pInput + 1)) << 16;
    retValue += ((uint64_t) *(pInput + 1)) << 24;
